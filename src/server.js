...
// new middleware
const localQueryMiddleware = (req, res, next) => {
...
server.get('/accepted-answer/:soID', localQueryMiddleware, (req, res) => {
  const post = req.post;
...
server.get('/top-answer/:soID', localQueryMiddleware, (req, res) => {
  const post = req.post;
